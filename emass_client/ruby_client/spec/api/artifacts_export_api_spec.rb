...
# Unit tests for EmassClient::ArtifactsExportApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ArtifactsExportApi' do
  before do
    # run before each test
    @instance = EmassClient::ArtifactsExportApi.new
  end
  ...
  describe 'test an instance of ArtifactsExportApi' do
    it 'should create an instance of ArtifactsExportApi' do
      expect(@instance).to be_instance_of(EmassClient::ArtifactsExportApi)
    end
  end
