...
# Unit tests for SwaggerClient::MilestonesGet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MilestonesGet' do
  before do
    # run before each test
    @instance = SwaggerClient::MilestonesGet.new
  end
  ...
  describe 'test an instance of MilestonesGet' do
    it 'should create an instance of MilestonesGet' do
      expect(@instance).to be_instance_of(SwaggerClient::MilestonesGet)
    end
  end
