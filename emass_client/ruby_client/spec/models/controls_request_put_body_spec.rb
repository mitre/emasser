...
# Unit tests for EmassClient::ControlsRequestPutBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ControlsRequestPutBody' do
  before do
    # run before each test
    @instance = EmassClient::ControlsRequestPutBody.new
  end
  ...
  describe 'test an instance of ControlsRequestPutBody' do
    it 'should create an instance of ControlsRequestPutBody' do
      expect(@instance).to be_instance_of(EmassClient::ControlsRequestPutBody)
    end
  end
