...
# Unit tests for EmassClient::ArtifactsRequestPutBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ArtifactsRequestPutBody' do
  before do
    # run before each test
    @instance = EmassClient::ArtifactsRequestPutBody.new
  end
  ...
  describe 'test an instance of ArtifactsRequestPutBody' do
    it 'should create an instance of ArtifactsRequestPutBody' do
      expect(@instance).to be_instance_of(EmassClient::ArtifactsRequestPutBody)
    end
  end
