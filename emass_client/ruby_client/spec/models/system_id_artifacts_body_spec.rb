...
# Unit tests for EmassClient::SystemIdArtifactsBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SystemIdArtifactsBody' do
  before do
    # run before each test
    @instance = EmassClient::SystemIdArtifactsBody.new
  end
  ...
  describe 'test an instance of SystemIdArtifactsBody' do
    it 'should create an instance of SystemIdArtifactsBody' do
      expect(@instance).to be_instance_of(EmassClient::SystemIdArtifactsBody)
    end
  end
