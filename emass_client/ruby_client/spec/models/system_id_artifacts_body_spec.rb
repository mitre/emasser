...
# Unit tests for SwaggerClient::SystemIdArtifactsBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SystemIdArtifactsBody' do
  before do
    # run before each test
    @instance = SwaggerClient::SystemIdArtifactsBody.new
  end
  ...
  describe 'test an instance of SystemIdArtifactsBody' do
    it 'should create an instance of SystemIdArtifactsBody' do
      expect(@instance).to be_instance_of(SwaggerClient::SystemIdArtifactsBody)
    end
  end
  ...
  describe 'test attribute "zipper"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
