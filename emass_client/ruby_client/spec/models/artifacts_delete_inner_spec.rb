...
# Unit tests for EmassClient::ArtifactsDeleteInner
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ArtifactsDeleteInner' do
  before do
    # run before each test
    @instance = EmassClient::ArtifactsDeleteInner.new
  end
  ...
  describe 'test an instance of ArtifactsDeleteInner' do
    it 'should create an instance of ArtifactsDeleteInner' do
      expect(@instance).to be_instance_of(EmassClient::ArtifactsDeleteInner)
    end
  end
