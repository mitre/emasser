...
# Unit tests for EmassClient::StaticCodeRequiredPost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StaticCodeRequiredPost' do
  before do
    # run before each test
    @instance = EmassClient::StaticCodeRequiredPost.new
  end
  ...
  describe 'test an instance of StaticCodeRequiredPost' do
    it 'should create an instance of StaticCodeRequiredPost' do
      expect(@instance).to be_instance_of(EmassClient::StaticCodeRequiredPost)
    end
  end
