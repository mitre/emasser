  ...
  class RoleCategory
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::RoleCategory` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::RoleCategory`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'system_acronym')
        self.system_acronym = attributes[:'system_acronym']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          system_acronym == o.system_acronym &&
          roles == o.roles
    end
    ...
    def hash
      [system_id, system_name, system_acronym, roles].hash
    end
