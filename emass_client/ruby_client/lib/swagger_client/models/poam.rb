...
module SwaggerClient
  class POAM
    ...
    # [Read-only] Indicates whether to include systems only.
    attr_accessor :system_only
    ...
    attr_accessor :scheduled_completion_date_start

    # [Required] Unix time format.
    attr_accessor :scheduled_completion_date_end
    ...
    def self.openapi_types
      {
        ...
        :'scheduled_completion_date_start' => :'Object',
        :'scheduled_completion_date_end' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::POAM` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::POAM`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'system_only')
        self.system_only = attributes[:'system_only']
      end
      ...
      if attributes.key?(:'scheduled_completion_date_start')
        self.scheduled_completion_date_start = attributes[:'scheduled_completion_date_start']
      end

      if attributes.key?(:'scheduled_completion_date_end')
        self.scheduled_completion_date_end = attributes[:'scheduled_completion_date_end']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          scheduled_completion_date_start == o.scheduled_completion_date_start &&
          scheduled_completion_date_end == o.scheduled_completion_date_end &&
