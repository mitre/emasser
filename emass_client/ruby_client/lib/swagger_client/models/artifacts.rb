...
module SwaggerClient
  class Artifacts
    ...
    attr_accessor :is_artifact_template
    ...
    def self.attribute_map
      {
        ...
        :'is_artifact_template' => :'isArtifactTemplate',
        :'type' => :'type',
        :'category' => :'category',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::Artifacts` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::Artifacts`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_artifact_template')
        self.is_artifact_template = attributes[:'is_artifact_template']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_artifact_template == o.is_artifact_template &&
          type == o.type &&
          category == o.category &&
    ...
    def hash
      [system_id, filename, is_inherited, description, is_artifact_template, type, category, ref_page_number, controls, ccis, mime_content_type, file_size, artifact_expiration_date, last_review_date].hash
    end
