...
module SwaggerClient
  class RegistrationApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [Register]
    def register_user(user_uid, opts = {})
      data, _status_code, _headers = register_user_with_http_info(user_uid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Register, Integer, Hash)>] Register data, response status code and response headers
    def register_user_with_http_info(user_uid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RegistrationApi.register_user ...'
      end
      # verify the required parameter 'user_uid' is set
      if @api_client.config.client_side_validation && user_uid.nil?
        fail ArgumentError, "Missing the required parameter 'user_uid' when calling RegistrationApi.register_user"
      end
      # resource path
      local_var_path = '/api/api-key'
